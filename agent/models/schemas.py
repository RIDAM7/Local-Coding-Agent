...
class FileOperation(BaseModel):
    type: Literal["create_file", "update_file", "delete_file"] = Field(..., description="Type of operation")
...
class Report(BaseModel):
    ...
    commands_executed: List[CommandExecution] = Field(default_factory=list, description="List of commands that were executed")
